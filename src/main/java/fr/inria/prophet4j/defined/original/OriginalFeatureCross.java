...
public class OriginalFeatureCross implements FeatureCross {
    public Integer featureCrossId;
    public List<Feature> features;

    public OriginalFeatureCross(Integer featureCrossId) {
        this.featureCrossId = featureCrossId;
        this.features = new ArrayList<>();
        if (featureCrossId >= FEATURE_BASE_3) {
            int tmp = featureCrossId - FEATURE_BASE_3;
        ...
        } else if (featureCrossId >= FEATURE_BASE_2) {
            int tmp = featureCrossId - FEATURE_BASE_2;
        ...
        } else if (featureCrossId >= FEATURE_BASE_1) {
            int tmp = featureCrossId - FEATURE_BASE_1;
        ...
        } else if (featureCrossId >= FEATURE_BASE_0) {
            int ordinal0 = featureCrossId - FEATURE_BASE_0;
    ...
    public OriginalFeatureCross(CrossType crossType, List<Feature> features) {
        ...
        switch (crossType) {
            case RF_CT:
                ...
                this.featureCrossId = FEATURE_BASE_0 + ordinal0;
                break;
            case POS_AF_RF_CT:
                ...
                this.featureCrossId = FEATURE_BASE_1 + ordinal0 * AF_SIZE * RF_SIZE + ordinal1 * RF_SIZE + ordinal2;
                break;
            case POS_AF_AF_CT:
                assert features.size() == 3;
                assert features.get(0) instanceof Position;
                ...
                this.featureCrossId = FEATURE_BASE_2 + ordinal0 * AF_SIZE * AF_SIZE + ordinal1 * AF_SIZE + ordinal2;
                break;
            case AF_VF_CT:
                ...
                this.featureCrossId = FEATURE_BASE_3 + ordinal0 * VF_SIZE + ordinal1;
                break;
        }
        this.features = features;
    }

    public Integer getFeatureCrossId() {
        return featureCrossId;
    }
