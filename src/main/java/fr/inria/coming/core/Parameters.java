...
public class Parameters {
	...
	public static void setUpProperties() {
		...
		MAX_LINES_PER_HUNK = ConfigurationProperties.getPropertyInteger("MAX_LINES_PER_HUNK");

		MAX_HUNKS_PER_FILECOMMIT = ConfigurationProperties.getPropertyInteger("MAX_HUNKS_PER_FILECOMMIT");

		MAX_FILES_PER_COMMIT = ConfigurationProperties.getPropertyInteger("MAX_FILES_PER_COMMIT");

		MAX_AST_CHANGES_PER_FILE = ConfigurationProperties.getPropertyInteger("MAX_AST_CHANGES_PER_FILE");

		MIN_AST_CHANGES_PER_FILE = ConfigurationProperties.getPropertyInteger("MIN_AST_CHANGES_PER_FILE");

		ONLY_COMMIT_WITH_TEST_CASE = ConfigurationProperties.getPropertyBoolean("excludeCommitWithOutTest");

		ONLY_COMMIT_WITH_TEST_CASE = ConfigurationProperties.getPropertyBoolean("only_roots");
