...
public class BorderArrangement implements Arrangement, Serializable {
    ...
    protected Size2D arrangeFF(BlockContainer container, Graphics2D g2,
        ...
        h[3] = h[2];
        if (this.rightBlock != null) {
			RectangleConstraint c4 = new RectangleConstraint(w[0], null, LengthConstraintType.FIXED, 0.0, new Range(0.0, ((constraint.getHeight()) - (h[0]))), LengthConstraintType.RANGE);
            Size2D size = this.rightBlock.arrange(g2, c4);
            w[3] = size.width;
        }
        h[4] = h[2];
