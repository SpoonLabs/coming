 ...
 * imaginary part.
 * <p>
 * Implementations of arithmetic operations handle <code>NaN</code> and infinite
 * values according to the rules for {@link java.lang.Double} arithmetic,
 * applying definitional formulas and returning <code>NaN</code> or infinite
 * values in real or imaginary parts as these arise in computation. See
 * individual method javadocs for details.
 * </p>
 * <p>
 * {@link #equals} identifies all values with <code>NaN</code> in either real or
 * imaginary part - e.g.,
 * 
 * <pre>
...
public class Complex implements FieldElement<Complex>, Serializable {
	 ...
	 * and <code>Double.POSITIVE_INFINITY</code> if neither part is
	 ...
	 * {@link #NaN} is returned; otherwise Infinite and NaN values are returned in
	 * the parts of the result according to the rules for {@link java.lang.Double}
	 * arithmetic.
	 * </p>
	 *
	...
	/**
	 * Return the conjugate of this complex number. The conjugate of "A + Bi" is "A
	 * - Bi".
	 * <p>
	 * {@link #NaN} is returned if either the real or imaginary part of this Complex
	 * number equals <code>Double.NaN</code>.
	 * </p>
	 * <p>
	 * If the imaginary part is infinite, and the real part is not NaN, the returned
	 * value has infinite imaginary part of the opposite sign - e.g. the conjugate
	 * of <code>1 + POSITIVE_INFINITY i</code> is
	 * <code>1 - NEGATIVE_INFINITY i</code>
	 * </p>
	 *
	 ...
	 * </pre>
	 * 
	 * but uses <a href="http://doi.acm.org/10.1145/1039813.1039814"> prescaling of
	 * operands</a> to limit the effects of overflows and underflows in the
	 * computation.
	 * </p>
	 * <p>
	 ...
	 * <li>If this and <code>rhs</code> are both infinite, {@link #NaN} is
	 * returned.</li>
	 * <li>If this is finite (i.e., has no infinite or NaN parts) and
	 * <code>rhs</code> is infinite (one or both parts infinite), {@link #ZERO} is
	 * returned.</li>
	 * <li>If this is infinite and <code>rhs</code> is finite, NaN values are
	 * returned in the parts of the result if the {@link java.lang.Double} rules
	 * applied to the definitional formula force NaN results.</li>
	 * </ul>
	 * </p>
	 *
	 * @param rhs the other complex number
	 ...
	 * same, and neither is <code>Double.NaN</code>, the two Complex objects are
	 * considered to be equal.
	 * </p>
	 * <p>
	 * All <code>NaN</code> values are considered to be equal - i.e, if either (or
	 ...
	 * <code>Double.NEGATIVE_INFINITY</code>) and neither part is <code>NaN</code>.
	 *
	 * @return true if one or both parts of this complex number are infinite and
	 *         neither part is <code>NaN</code>
	 */
	 ...
	 * </p>
	 * <p>
	 * Returns {@link #NaN} if either this or <code>rhs</code> has one or more NaN
	 * parts.
	 * </p>
	 * Returns {@link #INF} if neither this nor <code>rhs</code> has one or more NaN
	 * parts and if either this or <code>rhs</code> has one or more infinite parts
	 * (same result is returned regardless of the sign of the components).
	 * </p>
	 * <p>
	 ...
	 * <p>
	 * Returns <code>Complex.NaN</code> if either real or imaginary part of this
	 * Complex number equals <code>Double.NaN</code>.
	 * </p>
	 *
	 ...
	 * argument is <code>NaN</code> or infinite.
	 * </p>
	 *
	...
	/**
	 * Compute the <a href="http://mathworld.wolfram.com/Cosine.html" TARGET="_top">
	 ...
	 * "_top"> exponential function</a> of this complex number.
	 * <p>
	 * Implements the formula:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * Returns {@link Complex#NaN} if either real or imaginary part of the input
	 * argument is <code>NaN</code> or infinite, or if <code>y</code> equals
	 * {@link Complex#ZERO}.
	 * </p>
	 *
	...
	/**
	 * Compute the <a href="http://mathworld.wolfram.com/Sine.html" TARGET="_top">
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/SquareRoot.html" TARGET="_top"> square
	 * root</a> of this complex number.
	 * <p>
	 ...
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/SquareRoot.html" TARGET="_top"> square
	 * root</a> of 1 - <code>this</code><sup>2</sup> for this complex number.
	 * <p>
	 ...
	 * representing this number in the complex plane. The value returned is between
	 * -PI (not inclusive) and PI (inclusive), with negative values returned for
	 * numbers with negative imaginary parts.
	 * </p>
	 * <p>
	 * If either real or imaginary part (or both) is NaN, NaN is returned. Infinite
	 * parts are handled as java.Math.atan2 handles them, essentially treating
	 * finite parts as zero in the presence of an infinite coordinate and returning
	 * a multiple of pi/4 depending on the signs of the infinite parts. See the
	 * javadoc for java.Math.atan2 for full details.
	 * </p>
	 *
	 ...
	 * </p>
	 * <p>
	 * Subclasses will need to override {@link #createComplex} to deserialize
	 * properly
	 * </p>
	 * 
